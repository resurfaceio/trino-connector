...
public class ResurfaceTables {
    ...
    public static final class MessageTable {
        ...
        public static final List<ColumnMetadata> COLUMNS = ImmutableList.of(
                ...
                new ColumnMetadata("bitmap_categories", BIGINT),                                   // 31 (v3.1)
                ...
                new ColumnMetadata("bitmap_request_quality", BIGINT),                              // 36 (v3.1)
                ...
                new ColumnMetadata("bitmap_response_quality", BIGINT),                             // 40 (v3.1)
                ...
                new ColumnMetadata("bitmap_unused1", BIGINT),                                      // 44 (v3.1)
